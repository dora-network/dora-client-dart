...
part 'model/account_balance_transfer.dart';
part 'model/account_portfolio_response_v2.dart';
part 'model/account_portfolio_v2.dart';
part 'model/account_summary_v2.dart';
part 'model/account_v2.dart';
part 'model/add_trading_challenge_users_request.dart';
part 'model/affiliate_attribution.dart';
part 'model/affiliate_attribution_envelope.dart';
part 'model/affiliate_cash_flow.dart';
part 'model/affiliate_cash_flow_report.dart';
part 'model/affiliate_cash_flow_report_envelope.dart';
part 'model/affiliate_error.dart';
part 'model/affiliate_membership.dart';
part 'model/affiliate_membership_list_envelope.dart';
part 'model/affiliate_program.dart';
part 'model/affiliate_program_envelope.dart';
part 'model/affiliate_program_list_envelope.dart';
part 'model/affiliate_referral.dart';
part 'model/affiliate_referral_report.dart';
part 'model/affiliate_referral_report_envelope.dart';
part 'model/affiliate_referrer.dart';
part 'model/affiliate_referrer_envelope.dart';
part 'model/affiliate_referrer_list_envelope.dart';
part 'model/all_positions.dart';
part 'model/all_positions_response_envelope.dart';
...
part 'model/asset_yield.dart';
part 'model/asset_yield_resolution.dart';
part 'model/assign_affiliate_referral_request.dart';
part 'model/balance_transfer.dart';
part 'model/balances_response.dart';
part 'model/bond.dart';
part 'model/bond_kind.dart';
part 'model/bond_run_status.dart';
part 'model/cancel_order_response_envelope.dart';
part 'model/candle.dart';
part 'model/candle_resolution.dart';
part 'model/cash_reserve_breakdown.dart';
part 'model/cash_reserve_response.dart';
part 'model/cash_reserve_response_envelope.dart';
...
part 'model/claim_promo_link_request.dart';
part 'model/claim_trading_challenge_response.dart';
part 'model/claim_trading_challenge_response_envelope.dart';
part 'model/close_account_request.dart';
...
part 'model/copy_trader.dart';
part 'model/country_code.dart';
part 'model/coupon_kind.dart';
...
part 'model/create_affiliate_program_request.dart';
part 'model/create_conditional_order_request.dart';
part 'model/create_conditional_order_response_data.dart';
part 'model/create_conditional_order_response_envelope.dart';
...
part 'model/create_trading_challenge_qr_request.dart';
part 'model/create_trading_challenge_request.dart';
part 'model/create_withdrawal_request.dart';
part 'model/credit_rating.dart';
...
part 'model/deposit_args.dart';
part 'model/deposit_call.dart';
part 'model/deposit_instruction_for_chain.dart';
...
part 'model/get_copy_traders_response.dart';
part 'model/get_pn_l_ranking_response.dart';
part 'model/get_realized_pnl_settlements_response_envelope.dart';
part 'model/get_top_of_book_response_envelope.dart';
part 'model/historical_leverage_interest_rate.dart';
part 'model/historical_leverage_interest_rates.dart';
part 'model/historical_leverage_interest_rates_response_envelope.dart';
...
part 'model/issue_promo_link_batch_request.dart';
part 'model/issue_promo_link_batch_response.dart';
part 'model/issue_promo_link_batch_response_all_of_data.dart';
part 'model/issued_promo_link.dart';
part 'model/ledger_accounts_response_v2_envelope.dart';
...
part 'model/leverage_interest_rate.dart';
part 'model/leverage_interest_rate_response_envelope.dart';
...
part 'model/list_users_response_envelope.dart';
part 'model/list_withdrawals_response_envelope.dart';
part 'model/live_orderbook.dart';
part 'model/lock_withdrawal_fee_request.dart';
part 'model/margin.dart';
part 'model/metadata.dart';
part 'model/module_balance.dart';
part 'model/new_isolated_account_request_v2.dart';
part 'model/new_isolated_account_response_v2_envelope.dart';
...
part 'model/permit_domain.dart';
part 'model/permit_message.dart';
part 'model/permit_typed_data.dart';
part 'model/pn_l_ranking_response.dart';
part 'model/pn_l_ranking_responses.dart';
part 'model/pn_l_ranking_summary.dart';
...
part 'model/position_side.dart';
part 'model/position_type.dart';
part 'model/price_level.dart';
part 'model/promo_attribution_response.dart';
part 'model/promo_attribution_response_all_of_data.dart';
part 'model/promo_attribution_source.dart';
part 'model/promo_claim_response_envelope.dart';
part 'model/promo_claim_response_envelope_all_of_data.dart';
part 'model/promo_claim_state.dart';
part 'model/promo_link_admin.dart';
part 'model/promo_link_batch_list_response.dart';
part 'model/promo_link_batch_list_response_all_of_data.dart';
part 'model/promo_link_batch_summary.dart';
part 'model/promo_link_list_response.dart';
part 'model/promo_link_list_response_all_of_data.dart';
part 'model/promo_link_status.dart';
part 'model/promo_source_type.dart';
part 'model/realized_pnl_settlement.dart';
part 'model/realized_pnl_settlements.dart';
part 'model/register_affiliate_referrer_request.dart';
part 'model/remove_trading_challenge_users_request.dart';
part 'model/repay_usd_request.dart';
part 'model/repay_usd_response_envelope.dart';
part 'model/repay_usd_result.dart';
part 'model/response_envelope.dart';
part 'model/response_envelope_of_list_assets.dart';
part 'model/review_trading_challenge_registration_request.dart';
part 'model/revoke_api_key_data.dart';
part 'model/revoke_api_key_response_envelope.dart';
part 'model/revoke_promo_link_request.dart';
part 'model/revoke_promo_link_response.dart';
part 'model/revoke_promo_link_response_all_of_data.dart';
...
part 'model/settle_realized_pnl_record_response_envelope.dart';
part 'model/side.dart';
part 'model/stream_assets_entry.dart';
part 'model/stream_candles_entry.dart';
part 'model/stream_current_leverage_accrued_interest_response.dart';
...
part 'model/tenant_guarantee_fund_history.dart';
part 'model/tenant_guarantee_fund_history_response_envelope.dart';
part 'model/tenant_guarantee_fund_row.dart';
part 'model/tenant_guarantee_fund_summary.dart';
part 'model/tenant_restrictions.dart';
part 'model/terminate_trading_challenge_response.dart';
part 'model/terminate_trading_challenge_response_envelope.dart';
...
part 'model/trading_challenge_qr.dart';
part 'model/trading_challenge_registration_request.dart';
part 'model/trading_challenge_registration_request_list_response_envelope.dart';
part 'model/trading_challenge_registration_request_response_envelope.dart';
part 'model/trading_challenge_response_envelope.dart';
part 'model/trading_challenge_result.dart';
part 'model/trading_challenge_results_response_envelope.dart';
part 'model/trading_challenge_status.dart';
part 'model/trading_challenge_type.dart';
...
part 'model/transactions_settlement.dart';
part 'model/transactions_settlement_request.dart';
part 'model/transactions_settlements_response.dart';
part 'model/transactions_settlements_response_envelope.dart';
part 'model/transfer_account_balances_request.dart';
part 'model/transfer_account_balances_response_envelope.dart';
...
part 'model/typed_data_field.dart';
part 'model/unite_position_request.dart';
part 'model/unite_position_response_envelope.dart';
part 'model/united_position.dart';
part 'model/update_affiliate_program_request.dart';
part 'model/update_affiliate_program_request_description.dart';
part 'model/update_affiliate_program_request_is_active.dart';
part 'model/update_affiliate_program_request_name.dart';
part 'model/update_field_boolean.dart';
part 'model/update_field_date_time.dart';
part 'model/update_field_decimal.dart';
part 'model/update_field_integer.dart';
part 'model/update_field_string.dart';
part 'model/update_roles_string.dart';
part 'model/update_trading_challenge_request.dart';
part 'model/update_user_config_request.dart';
part 'model/update_user_kyc_request.dart';
part 'model/update_user_kyc_response.dart';
part 'model/update_user_kyc_response_envelope.dart';
...
part 'model/user_deactivation.dart';
part 'model/user_deactivation_list_response_envelope.dart';
part 'model/user_deactivation_response_envelope.dart';
...
part 'model/web3_event_status.dart';
part 'model/web3_withdrawal_status.dart';
...
part 'model/withdrawal_response.dart';
part 'model/withdrawal_response_envelope.dart';
