...
String parameterToString(dynamic value) {
  ...
  if (value is OrderBookStatus) {
    return OrderBookStatusTypeTransformer().encode(value).toString();
  }
  if (value is OrderKind) {
    return OrderKindTypeTransformer().encode(value).toString();
  }
  if (value is OrderModifierKind) {
    return OrderModifierKindTypeTransformer().encode(value).toString();
  }
