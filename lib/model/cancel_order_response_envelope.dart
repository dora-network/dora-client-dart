...
class CancelOrderResponseEnvelope {
  ...
  static CancelOrderResponseEnvelope? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'metadata'), 'Required key "CancelOrderResponseEnvelope[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null, 'Required key "CancelOrderResponseEnvelope[metadata]" has a null value in JSON.');
        return true;
      }());
