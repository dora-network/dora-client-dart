...
class CreateOrUpdateUserResponse {
  ...
  static CreateOrUpdateUserResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'id'), 'Required key "CreateOrUpdateUserResponse[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "CreateOrUpdateUserResponse[id]" has a null value in JSON.');
        return true;
      }());
