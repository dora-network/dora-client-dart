...
class LiquidationTargetsResponseEnvelope {
  ...
  static LiquidationTargetsResponseEnvelope? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'metadata'), 'Required key "LiquidationTargetsResponseEnvelope[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null, 'Required key "LiquidationTargetsResponseEnvelope[metadata]" has a null value in JSON.');
        return true;
      }());
