...
class ListTransactionsResponseEnvelope {
  ...
  static ListTransactionsResponseEnvelope? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'metadata'), 'Required key "ListTransactionsResponseEnvelope[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null, 'Required key "ListTransactionsResponseEnvelope[metadata]" has a null value in JSON.');
        return true;
      }());
