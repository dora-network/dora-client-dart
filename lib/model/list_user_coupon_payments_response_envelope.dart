...
class ListUserCouponPaymentsResponseEnvelope {
  ...
  static ListUserCouponPaymentsResponseEnvelope? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'metadata'), 'Required key "ListUserCouponPaymentsResponseEnvelope[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null, 'Required key "ListUserCouponPaymentsResponseEnvelope[metadata]" has a null value in JSON.');
        return true;
      }());
