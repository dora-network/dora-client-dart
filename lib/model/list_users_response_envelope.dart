...
class ListUsersResponseEnvelope {
  ...
  static ListUsersResponseEnvelope? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'metadata'), 'Required key "ListUsersResponseEnvelope[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null, 'Required key "ListUsersResponseEnvelope[metadata]" has a null value in JSON.');
        return true;
      }());
