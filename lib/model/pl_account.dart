...
class PLAccount {
  ...
  @override
  String toString() => 'PLAccount[accountId=$accountId, accountName=$accountName, isGlobal=$isGlobal, rows=$rows, summary=$summary]';
  ...
  static PLAccount? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PLAccount(
        ...
        rows: PLAsset.listFromJson(json[r'rows']),
