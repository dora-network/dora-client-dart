...
class StreamAssetsResponse {
  ...
  StreamAssetsResponse({
    this.streamAssetsEntries = const [],
  });

  List<StreamAssetsEntry> streamAssetsEntries;

  @override
  bool operator ==(Object other) => identical(this, other) || other is StreamAssetsResponse &&
    _deepEquality.equals(other.streamAssetsEntries, streamAssetsEntries);

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (streamAssetsEntries.hashCode);

  @override
  String toString() => 'StreamAssetsResponse[streamAssetsEntries=$streamAssetsEntries]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'stream_assets_entries'] = this.streamAssetsEntries;
    return json;
  }
  ...
  static StreamAssetsResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return StreamAssetsResponse(
        streamAssetsEntries: StreamAssetsEntry.listFromJson(json[r'stream_assets_entries']),
      );
    }
    return null;
  }
