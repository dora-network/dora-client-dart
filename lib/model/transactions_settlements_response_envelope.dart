...
class TransactionsSettlementsResponseEnvelope {
  ...
  static TransactionsSettlementsResponseEnvelope? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'metadata'), 'Required key "TransactionsSettlementsResponseEnvelope[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null, 'Required key "TransactionsSettlementsResponseEnvelope[metadata]" has a null value in JSON.');
        return true;
      }());
