  ...
  static TransformedAssets? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TransformedAssets(
        gained: mapCastOfType<String, double>(json, r'gained') ?? const {},
        lost: mapCastOfType<String, double>(json, r'lost') ?? const {},
      );
    }
    return null;
  }
