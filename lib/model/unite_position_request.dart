...
class UnitePositionRequest {
  ...
  static UnitePositionRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'global_position_id'), 'Required key "UnitePositionRequest[global_position_id]" is missing from JSON.');
        assert(json[r'global_position_id'] != null, 'Required key "UnitePositionRequest[global_position_id]" has a null value in JSON.');
        return true;
      }());
