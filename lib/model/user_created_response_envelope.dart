...
class UserCreatedResponseEnvelope {
  ...
  static UserCreatedResponseEnvelope? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'metadata'), 'Required key "UserCreatedResponseEnvelope[metadata]" is missing from JSON.');
        assert(json[r'metadata'] != null, 'Required key "UserCreatedResponseEnvelope[metadata]" has a null value in JSON.');
        return true;
      }());
