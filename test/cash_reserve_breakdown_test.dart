...
// tests for CashReserveBreakdown
void main() {
  // final instance = CashReserveBreakdown();

  group('test CashReserveBreakdown', () {
    // Completed PAC (partially accrued coupon) obligations the user owes, in USD.
    // String completedPac
    test('to test the property `completedPac`', () async {
      // TODO
    });

    // Outstanding LAI (leverage accrued interest) the user owes, in USD.
    // String outstandingLai
    test('to test the property `outstandingLai`', () async {
      // TODO
    });
    ...
    test('to test the property `borrowedPortion`', () async {
      // TODO
    });

    // Configured absolute minimum requirement, in USD.
    // String floor
    test('to test the property `floor`', () async {
      // TODO
    });
