...
// tests for RealizedPnlSettlements
void main() {
  // final instance = RealizedPnlSettlements();

  group('test RealizedPnlSettlements', () {
    // A list of realized PnL settlements matching the query parameters of the request
    // List<RealizedPnlSettlement> settlements (default value: const [])
